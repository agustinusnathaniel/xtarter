...
<PackageManagers type="create" pkg="xtarter-app" args="my-app --yes" title="Scaffold with defaults" />

<PackageManagers type="create" pkg="xtarter-app" args=". -t vite-tailwind" title="Scaffold into current directory" />

<PackageManagers type="create" pkg="xtarter-app" args="my-app -t vite-tailwind --force" title="Overwrite existing directory" />

<PackageManagers type="create" pkg="xtarter-app" args="my-app --ref v1.0.0" title="Pin to a specific template version" />
