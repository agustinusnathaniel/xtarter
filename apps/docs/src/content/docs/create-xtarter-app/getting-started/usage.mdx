...
3. ### Pick a template
   ...
   <PackageManagers type="create" pkg="xtarter-app" args="my-app --template vite-tailwind" />
...
4. ### Choose a package manager
   ...
   <PackageManagers type="create" pkg="xtarter-app" args="my-app --pm bun" />
...
<PackageManagers type="create" pkg="xtarter-app" args="--preview" title="Preview all templates" />

<PackageManagers type="create" pkg="xtarter-app" args="--preview --template vite-tailwind" title="Preview a specific template" />
...
<PackageManagers type="create" pkg="xtarter-app" args="my-app --yes" />
...
<PackageManagers type="create" pkg="xtarter-app" args="my-app --no-git" />
