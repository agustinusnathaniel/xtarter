...
3. ### Pick a template
   ...
   <AllPackageManagers type="create" pkg="xtarter-app" args="my-app --template vite-tailwind" />
...
4. ### Choose a package manager
   ...
   <AllPackageManagers type="create" pkg="xtarter-app" args="my-app --pm bun" />
...
<AllPackageManagers type="create" pkg="xtarter-app" args="--preview" title="Preview all templates" />

<AllPackageManagers type="create" pkg="xtarter-app" args="--preview --template vite-tailwind" title="Preview a specific template" />
...
<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --yes" />
...
<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --no-git" />
