...
<PackageManagers type="create" pkg="xtarter-app" args="my-app --template next-chakra" />
...
<PackageManagers type="create" pkg="xtarter-app" args="my-app --template next-tailwind" />
...
<PackageManagers type="create" pkg="xtarter-app" args="my-app --template vite-chakra" />
...
<PackageManagers type="create" pkg="xtarter-app" args="my-app --template vite-hero" />
