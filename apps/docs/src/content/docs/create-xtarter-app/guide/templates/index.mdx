...
<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --template next-chakra" />
...
<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --template next-tailwind" />
...
<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --template vite-chakra" />
...
<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --template vite-hero" />
