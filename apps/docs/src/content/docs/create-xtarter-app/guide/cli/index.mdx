...
<AllPackageManagers type="create" pkg="xtarter-app" title="Interactive" />

<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --yes" title="Quick start with defaults" />

<AllPackageManagers type="create" pkg="xtarter-app" args=". -t vite-tailwind" title="Scaffold in current directory" />

<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --template vite-tailwind" title="Pick a template" />

<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --pm bun --no-git" title="Specific package manager, no git" />

<AllPackageManagers type="create" pkg="xtarter-app" args="my-app -t vite-tailwind --force" title="Overwrite existing directory" />

<AllPackageManagers type="create" pkg="xtarter-app" args="my-app --ref v1.0.0" title="Download a specific tag" />

<AllPackageManagers type="create" pkg="xtarter-app" args="preview next-tailwind" title="Preview a template" />
