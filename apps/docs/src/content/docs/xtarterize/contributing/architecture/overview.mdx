...
- packages/
  ...
  - tasks/ - [`@xtarterize/tasks`](https://github.com/agustinusnathaniel/xtarterize/tree/main/packages/tasks) - [`factory/`](https://github.com/agustinusnathaniel/xtarterize/tree/main/packages/tasks/src/factory), all task implementations
- apps/
