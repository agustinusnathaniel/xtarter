...
- `nx.json`
- `lerna.json`
- At least two of the `packages/`, `apps/`, or `services/` directories
...
| devEngines in package.json | `quality/package-engines` | Quality |
...
| Changelog config | `release/versionrc` | Release |
...
| pnpm workspace config | `workspace/pnpm-workspace` | Workspace |
