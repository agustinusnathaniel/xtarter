...
- [pnpm/setup](https://github.com/pnpm/setup) - Set up pnpm with caching
...
- [package.json devEngines](https://docs.npmjs.com/cli/v10/configuring-npm/package-json#devengines) - Development environment requirements
...
- [pnpm Workspace](https://pnpm.io/pnpm-workspace_yaml) - pnpm workspace configuration
