...
<AllPackageManagers type="dlx" pkg="xtarterize@latest" args='query "ci pipeline" --json' title="JSON output" />

<AllPackageManagers type="dlx" pkg="xtarterize@latest" args='init --compose "react project with ci and linting"' title="Rank an init plan" />
