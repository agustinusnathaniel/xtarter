...
<AllPackageManagers type="exec" pkg="xtarterize" args='query "linting and formatting tool" --limit 5' />

### Machine-readable output

<AllPackageManagers type="exec" pkg="xtarterize" args='query "ci pipeline" --json' />
...
<AllPackageManagers type="exec" pkg="xtarterize" args='init --compose "react project with ci and linting"' />
