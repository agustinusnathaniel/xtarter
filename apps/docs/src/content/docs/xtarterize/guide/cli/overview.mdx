...
<AllPackageManagers type="exec" pkg="xtarterize" args="doctor" />

<AllPackageManagers type="exec" pkg="xtarterize" args="doctor --verbose" title="Verbose" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="init" title="Basic" />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --dry-run" title="Dry run" />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --yes" title="Auto-apply" />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --skip lint/oxlint" title="Skip tasks" />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --only lint/biome,ts/incremental" title="Only specific" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="sync" />

<AllPackageManagers type="exec" pkg="xtarterize" args="sync --dry-run" title="Dry run" />

<AllPackageManagers type="exec" pkg="xtarterize" args="sync --yes" title="Auto-apply" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="diff" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="check" />

<AllPackageManagers type="exec" pkg="xtarterize" args="check --verbose" title="Verbose" />

<AllPackageManagers type="exec" pkg="xtarterize" args="check --badge conformance.svg" title="Badge" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="add lint/biome" title="Specific task" />

<AllPackageManagers type="exec" pkg="xtarterize" args="add" title="Interactive" />

Browse tasks by category, select multiple, and apply with per-task confirmation.

<AllPackageManagers type="exec" pkg="xtarterize" args="add --all" title="All tasks" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="undo" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="restore tsconfig.json" />

<AllPackageManagers type="exec" pkg="xtarterize" args="restore biome.json --yes" title="Auto-restore" />

<AllPackageManagers type="exec" pkg="xtarterize" args="restore tsconfig.json --quiet" title="Quiet" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="list" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args='query "strict typescript"' />

<AllPackageManagers type="exec" pkg="xtarterize" args='query "ci pipeline" --json' title="JSON output" />

<AllPackageManagers type="exec" pkg="xtarterize" args='query "linting and formatting tool" --limit 5' title="Limit results" />
