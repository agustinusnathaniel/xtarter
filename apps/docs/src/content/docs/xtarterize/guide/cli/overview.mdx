...
<AllPackageManagers type="exec" pkg="xtarterize" args="doctor" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="doctor --verbose" title="Verbose" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="init" title="Basic" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --dry-run" title="Dry run" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --yes" title="Auto-apply" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --skip lint/oxlint" title="Skip tasks" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --only lint/biome,ts/incremental" title="Only specific" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="sync" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="sync --dry-run" title="Dry run" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="sync --yes" title="Auto-apply" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="diff" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="check" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="check --verbose" title="Verbose" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="check --badge conformance.svg" title="Badge" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="add lint/biome" title="Specific task" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="add" title="Interactive" pkgManagers={['npm']} />

Browse tasks by category, select multiple, and apply with per-task confirmation.

<AllPackageManagers type="exec" pkg="xtarterize" args="add --all" title="All tasks" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="undo" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="restore tsconfig.json" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="restore biome.json --yes" title="Auto-restore" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="restore tsconfig.json --quiet" title="Quiet" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="list" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args='query "strict typescript"' pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args='query "ci pipeline" --json' title="JSON output" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args='query "linting and formatting tool" --limit 5' title="Limit results" pkgManagers={['npm']} />
