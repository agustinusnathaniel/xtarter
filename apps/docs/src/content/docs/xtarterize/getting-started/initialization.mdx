...
<AllPackageManagers type="exec" pkg="xtarterize" args="init" />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="init --dry-run" title="Preview" />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --yes" title="Apply all" />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --skip codegen/plop,agent/skills-install" title="Skip tasks" />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --only lint/biome" title="Only specific" />
