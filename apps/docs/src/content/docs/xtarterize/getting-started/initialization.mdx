...
<AllPackageManagers type="exec" pkg="xtarterize" args="init" pkgManagers={['npm']} />
...
<AllPackageManagers type="exec" pkg="xtarterize" args="init --dry-run" title="Preview" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --yes" title="Apply all" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --skip codegen/plop,agent/skills-install" title="Skip tasks" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="init --only lint/biome" title="Only specific" pkgManagers={['npm']} />
