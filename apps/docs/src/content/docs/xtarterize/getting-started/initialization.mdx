...
<PackageManagers type="exec" pkg="xtarterize" args="init" pkgManagers={['npm']} />
...
<PackageManagers type="exec" pkg="xtarterize" args="init --dry-run" title="Preview" pkgManagers={['npm']} />

<PackageManagers type="exec" pkg="xtarterize" args="init --yes" title="Apply all" pkgManagers={['npm']} />

<PackageManagers type="exec" pkg="xtarterize" args="init --skip codegen/plop,agent/skills-install" title="Skip tasks" pkgManagers={['npm']} />

<PackageManagers type="exec" pkg="xtarterize" args="init --only lint/biome" title="Only specific" pkgManagers={['npm']} />
