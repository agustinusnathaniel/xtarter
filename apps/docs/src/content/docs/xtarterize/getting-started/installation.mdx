...
<AllPackageManagers type="exec" pkg="xtarterize" args="--version" pkgManagers={['npm']} />

<AllPackageManagers type="exec" pkg="xtarterize" args="--help" pkgManagers={['npm']} />
...
<LinkButton href="/xtarterize/getting-started/initialization/">Initialize your project →</LinkButton>
