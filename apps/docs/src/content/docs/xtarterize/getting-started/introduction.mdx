...
- Check the [CLI Reference](/xtarterize/guide/cli/overview/) for all commands and flags
- Review the [Tasks Guide](/xtarterize/guide/tasks/overview/) to see what conformance tasks are available
- Look at the [Contributing](/xtarterize/contributing/architecture/overview/) section if you want to contribute to the project
