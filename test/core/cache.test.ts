...
describe('detect cache', () => {
  ...
  test('invalidates cache when package.json is modified', async () => {
  ...
  test('invalidates cache when lockfile appears', async () => {
  ...
  test('invalidates cache when lockfile is removed', async () => {
  ...
  test('invalidates cache when config dir file is modified', async () => {
  ...
  test('includes root detector files in fingerprint', async () => {
  ...
  test('invalidates cache when tsconfig is added', async () => {
  ...
  test('invalidates cache when tsconfig is removed', async () => {
  ...
  test('invalidates cache when vite.config is added', async () => {
  ...
  test('invalidates cache when an ancestor monorepo marker is added or removed', async () => {
  ...
  test('invalidates cache when .nvmrc is added or changed', async () => {
